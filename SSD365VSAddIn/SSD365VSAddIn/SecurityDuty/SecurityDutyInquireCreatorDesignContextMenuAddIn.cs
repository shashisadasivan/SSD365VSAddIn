...
namespace SSD365VSAddIn.SecurityDuty
{
    ...
    class SecurityDutyInquireCreatorDesignContextMenuAddIn : DesignerMenuBase
    {
        #region Member variables
        private const string addinName = "SSD365VSAddIn.SecurityDutyInquireCreatorDesignContextMenuAddIn";
        #endregion
        ...
        public override string Caption
        {
            get
            {
                return AddinResources.SecurityDutyInquireCreatorDesignContextMenuAddInCaption;
            }
        }
        ...
        public override string Name
        {
            get
            {
                return SecurityDutyInquireCreatorDesignContextMenuAddIn.addinName;
            }
        }
        #endregion
        ...
        public override void OnClick(AddinDesignerEventArgs e)
        {
            try
            {
                ...
                if (e.SelectedElement is ISecurityPrivilege)
                {
                    ...
                    SecurityDutyCreator.CreateDuty_fromSecPriv(e.SelectedElement as ISecurityPrivilege, Common.Constants.INQUIRE);
