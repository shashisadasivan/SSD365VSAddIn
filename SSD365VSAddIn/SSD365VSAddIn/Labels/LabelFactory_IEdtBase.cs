...
namespace SSD365VSAddIn.Labels
{
    internal class LabelFactory_IEdtBase : LabelFactory
    {
        ...
        public override void ApplyLabel()
        {
            ...
            {
                this.iEdtBase.Label = this.GetLabel(this.iEdtBase.Label);
                this.iEdtBase.HelpText = this.GetLabel(this.iEdtBase.HelpText);
                this.iEdtBase.CollectionLabel = this.GetLabel(this.iEdtBase.CollectionLabel);
                ...
                if (iEdtBase is IEdtDate)
                {
                    ...
                    edt.MaxDateLabel = this.GetLabel(edt.MaxDateLabel);
                }
